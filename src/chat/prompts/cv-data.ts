export const CV_DATA = {
  ...
  experience: [
    ...
    },
    {
      ...
      period: 'Gennaio 2024 – Novembre 2024',
      location: null,
      highlights: [
    ...
    },
    {
      ...
      period: 'Giugno 2021 – Novembre 2023',
      location: null,
      highlights: [
  ...
  projects: [
    {
      name: 'EasyDrink (oggi Steal Drink)',
      description: 'App di offerte su aperitivi/locali, oggi live in 20 locali a Pisa.',
      highlights: [
  ...
  skills: {
    ...
    cloud: ['GCP (Cloud Run, VM, Cloud Storage)', 'AWS', 'Cloudflare', 'PM2', 'Nginx'],
    architecture: ['sistemi ad alto traffico', 'caching multilivello', 'invalidazione cache', 'WebSocket real-time', 'elaborazione asincrona'],
    messaging: ['BullMQ', 'Azure Service Bus', 'GCP Pub/Sub', 'NestJS Task Scheduler'],
    testing: ['unit test', 'integration test', 'E2E', 'load testing con k6'],
    monitoring: ['Grafana', 'Sentry', 'GCP Monitoring'],
    integrations: ['API OpenAI', 'Shopify API', 'Magic Link', 'provider di autenticazione esterni'],
    frontend: ['React', 'Next.js', 'Flutter (supporto)'],
  },
  ...
  languages: [
    ...
    { lang: 'Inglese', level: 'intermedio (lettura tecnica fluente)' },
  ],
} as const;
